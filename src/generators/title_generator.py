    ...
    def generate_cover_prompts(self, novel_type: str, titles: Dict[str, str],
        ...
        try:
            ...
            for platform in missing_platforms:
                if platform == "番茄小说":
                    cover_prompts[platform] = "俊朗青年、现代修仙服、眼神坚毅、都市高楼背景、霓虹光效、2:3竖版构图"
                elif platform == "七猫小说":
                    cover_prompts[platform] = "仙气飘飘的男子、古风长袍、云雾缭绕、仙山背景、水墨意境、2:3竖版构图"
                elif platform == "起点中文网":
                    cover_prompts[platform] = "英气逼人的少年、战甲、金光万丈、战场背景、热血沸腾、2:3竖版构图"
                elif platform == "书旗小说":
                    cover_prompts[platform] = "气质沉稳的男子、道袍、水墨风格、道观背景、简洁大气、2:3竖版构图"
                else:  # 掌阅
                    cover_prompts[platform] = "温润如玉的男子、儒雅长衫、月光如水、庭院背景、细腻唯美、2:3竖版构图"
